# Spring Boot Backend Login Page

This file contains the HTML and configuration for a modern, visually appealing login page for a Spring Boot application using Thymeleaf and Tailwind CSS.

## Instructions

1.  **Save the HTML:** Save the first HTML block to `src/main/resources/templates/login.html`.
2.  **Thymeleaf Dependency:** Ensure the `spring-boot-starter-thymeleaf` dependency is in your `pom.xml`.
...
<body class="min-h-screen gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10 card-animate">
        <div class="bg-white rounded-2xl shadow-2xl p-8 sm:p-10">
            ...
            <!-- Error Message -->
            <div th:if="${param.error}" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
            ...
            <div th:if="${param.logout}" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                <div class="flex items-center gap-3">
                    <div class="flex-shrink-0">
            ...
            <form class="space-y-5" method="post" th:action="@{/login}">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <a href="/forgot-password" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
                            Forgot password?
                        </a>
                    </div>
                    <input 
                ...
                <div class="flex items-center">
                    ...
                    >
                    <label for="remember-me" class="ml-2.5 block text-sm text-gray-700 cursor-pointer">
                ...
                <button 
                    type="submit"
                    class="btn-primary w-full py-3.5 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                    Sign in
                </button>
            </form>
            ...
            <div class="relative my-8">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-white text-gray-500">New to OERMS?</span>
                </div>
            </div>
            ...
            <div class="text-center">
                <a 
                    th:href="@{${@environment.getProperty('app.frontend-url', 'http://localhost:3000')} + '/register'}"
        ...
        <p class="mt-6 text-center text-sm text-white/80">
            © 2024 OERMS. All rights reserved.
        </p>
    </div>
</body>
</html>
...
## Optional: `src/main/resources/templates/error/login-error.html`

This is an optional, simplified error page to handle login failures gracefully.
...
## Spring Security Configuration (for reference)

Add the following to your `SecurityConfig.java`:
...
You will also need a `WebMvcConfigurer` to serve the login page view:
...
Add the following properties to your `application.yml` to configure external URLs.
