...
import { QuestionDTO, UpdateQuestionRequest } from '@/lib/types';
...
export default function EditQuestionPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        const loadQuestion = async () => {
            try {
                ...
                const questionData = await apiClient.getQuestion(params.id);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const updatedQuestion = await apiClient.updateQuestion(params.id, formData);
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-6">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">Update question details</p>
            </div>
